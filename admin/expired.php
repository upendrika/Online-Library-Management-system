    ...
    <?php
      ...
      <form method="post" action="">
          ...
          <form method="post" action="" name="form1">
            ...
            <button style='background-color: #f09b0ee6;color:black;'class="btn btn-default" name="submit" type="submit"><b>Submit</b></button><br>
          </form>
        </div>
            <br><h3 style="text-align: center;">Date Expired List</h3>
    ...
    $c=0;
      ...
      while($row=mysqli_fetch_assoc($res))
      {
        echo "<tr style='background-color: #fff1c9; color:black;'>";
          ...
          echo "<td><strong>" . $row['approve'] . "</strong></td>";
          echo "<td><strong>" . $row['issue'] . "</strong></td>";
          echo "<td><strong>" . $row['return'] . "</strong></td>";
        echo "</tr>";
      }
    echo "</table>";
        echo "</div>";
