...
<div class="container">
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: #f09b0ee6; color:black;" type="submit" name="submit" class="btn btn-default">
	...
	<h2> Students Fine Infomation</h2>
	<?php
		...
		echo "<table class='table table-bordered table-hover' >";
			...
			while($row=mysqli_fetch_assoc($q))
			{
				...
				echo "<td><strong>" . $row['returned'] . "</strong></td>";
				echo "<td><strong>" . $row['day'] . "</strong></td>";
				echo "<td><strong>" . $row['fine'] . "</strong></td>";
