...
function closeNav() {
  ...
  <!--___________________search bar_________________-->
  ...
  <div class="srch">
    ...
    <form class="navbar-form" method="post" name="form1">
        ...
        <button style="background-color: #f09b0ee6;" type="submit" name="submit1" class="btn btn-default">Delete
        </button>
    </form>
  </div>
  ...
  <?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      {
      echo '<p style="color: white;">Sorry! No book found. Try searching again.</p>';
      }
      else
      {
    ...
    echo "<thead class='sticky-header'>";
      ...
      {
        echo "<tr style='background-color: #fff1c9;'>";
        ...
        echo "<button style='background-color: #f09b0ee6; color: black;'>View Book</button>";
        echo "</a>";
        echo "</td>";
